  ...
  return (
    <motion.div
      ...
      style={{
        ...
        padding: "16px 18px", boxShadow: `4px 4px 0px ${accent}`,
        position: "relative", overflow: "hidden",
      }}
    >
      <div style={{ position: "absolute", top: 4, right: 4, width: 6, height: 6, background: accent, opacity: 0.5 }} />
      <p style={{ fontSize: 9, letterSpacing: "0.2em", color: accent, fontFamily: "'VT323', monospace", marginBottom: 8 }}>{label}</p>
      <div style={{ display: "flex", alignItems: "baseline", gap: 4 }}>
        <span style={{ fontSize: 38, fontFamily: "'VT323', monospace", color: text, lineHeight: 1, textShadow: `0 0 10px ${accent}88` }}>{value}</span>
        {unit && <span style={{ fontSize: 14, color: accent, fontFamily: "'VT323', monospace" }}>{unit}</span>}
      </div>
      ...
      {bar && (
        <div style={{ marginTop: 10, height: 6, background: "rgba(0,0,0,0.4)", border: `1px solid ${accent}44` }}>
          <motion.div
            initial={{ width: 0 }}
  ...
  return (
    <>
      ...
      <div style={{ minHeight: "100vh", background: theme.bg, transition: "background 1.5s ease", position: "relative", zIndex: 1 }}>
        ...
        {/* Marquee */}
        <div style={{ background: theme.accent, padding: "4px 0", overflow: "hidden", borderBottom: `3px solid ${theme.accent2}` }}>
          <div className="marquee-inner" style={{ fontSize: 13, color: "#000", fontFamily: "'VT323', monospace", letterSpacing: "0.15em" }}>
            ★ SELRVK.DEV | WEATHER APP ★ REAL-TIME ATMOSPHERIC DATA ★ POWERED BY WEATHERAPI ★ STAY CONNECTED ★ SELRVK.DEV | WEATHER APP ★ REAL-TIME ATMOSPHERIC DATA ★ STAY CONNECTED ★&nbsp;
          </div>
        </div>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 32px", position: "relative", zIndex: 2 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: 28, paddingBottom: 20 }}>
            <div>
              <div className="glitch" style={{
                fontFamily: "'Press Start 2P', monospace", fontSize: 18, color: theme.accent,
                textShadow: `0 0 20px ${theme.accent}, 2px 2px 0 ${theme.accent2}`, lineHeight: 1,
              }}>
              ...
              <div style={{
                ...
                <input
                  ...
                  style={{
                    ...
                    fontFamily: "'VT323', monospace", fontSize: 16, width: 180, letterSpacing: "0.08em",
                  }}
                />
              </div>
              <button type="submit" style={{
                background: theme.accent, border: `3px solid ${theme.accent2}`, borderLeft: "none",
                padding: "8px 20px", color: "#000", fontFamily: "'Press Start 2P', monospace",
          ...
          <AnimatePresence mode="wait">
            {weather && !loading && (
              ...
              >
                ...
                >
                  ...
                  <div>
                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
                      ...
                      <span style={{ fontSize: 14, color: theme.accent, fontFamily: "'VT323', monospace", letterSpacing: "0.15em" }}>
                    ...
                    <h1 style={{
                      ...
                      textShadow: `0 0 20px ${theme.accent}88`, marginBottom: 20,
                    }}>
                      {weather.location.region || weather.location.name}
                    </h1>
                    <div style={{
                      display: "inline-flex", alignItems: "center", gap: 10,
                      border: `2px solid ${theme.accent}`, padding: "6px 14px",
                      background: "rgba(0,0,0,0.3)", marginBottom: 20,
                    }}>
                      <span style={{ fontSize: 16 }}>{weather.current.is_day === 1 ? "☀️" : "🌙"}</span>
                      <span style={{ fontFamily: "'VT323', monospace", fontSize: 16, color: theme.accent, letterSpacing: "0.1em" }}>
                  ...
                  <div style={{ textAlign: "right" }}>
                    ...
                    <div style={{ fontFamily: "'VT323', monospace", fontSize: 18, color: theme.accent, opacity: 0.5, marginTop: 6 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: 12, marginBottom: 16 }}>
                  ...
                  <motion.div
                    ...
                    style={{
                      ...
                      boxShadow: `4px 4px 0 ${theme.accent}`, padding: "16px 18px",
                  ...
                  >
                    ...
                    <p style={{ fontSize: 9, letterSpacing: "0.2em", color: theme.accent, fontFamily: "'VT323', monospace", alignSelf: "flex-start" }}>:: COMPASS ::</p>
                    <WindCompass degree={weather.current.wind_degree} accent={theme.accent} />
                    <p style={{ fontSize: 12, color: theme.accent, fontFamily: "'VT323', monospace", opacity: 0.7 }}>
                ...
                <motion.div
                  ...
                  style={{
                    border: `2px solid ${theme.accent}44`, padding: "10px 16px",
                    display: "flex", justifyContent: "space-between", alignItems: "center",
                    marginBottom: 32, background: "rgba(0,0,0,0.2)",
                  }}
                >
                  <span style={{ fontSize: 12, color: theme.accent, opacity: 0.5, fontFamily: "'VT323', monospace", letterSpacing: "0.1em" }}>
                    SYS: NOMINAL // DATA: LIVE // {weather.current.is_day === 1 ? "DAYTIME" : "NIGHTTIME"}<span className="blink">_</span>
                  </span>
                  <span style={{ fontSize: 12, color: theme.accent, opacity: 0.4, fontFamily: "'VT323', monospace" }}>
            ...
            {loading && (
              ...
              >
                <div style={{ fontFamily: "'Press Start 2P', monospace", fontSize: 14, color: theme.accent, textShadow: `0 0 10px ${theme.accent}` }}>
                  LOADING
                </div>
                ...
                <div style={{ fontSize: 13, color: theme.accent, opacity: 0.5, fontFamily: "'VT323', monospace", letterSpacing: "0.1em" }}>
